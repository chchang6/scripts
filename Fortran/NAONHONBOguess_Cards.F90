...
! then assembles a Gaussian Cards input deck in 5F16.9 for initial
! guess based on NBOs, NHOs, and NAOs. CHC 01/31/06.
IMPLICIT NONE
...
ALLOCATE (NAO(1:numbasis, 1:numbasis), STAT=iostat)
