...
for i in confstring:
   if i == '_' and quantum == 0: quantum = 1
      ...
      counter+=1
print confdict
F4Ocharges = {'C':-0.81869, 'H':0.33818, 'S':-0.36468}
F4Rcharges = {'C':-0.82048, 'H':0.32061, 'S':-0.60058}
F2Ocharges = {'C':-0.81869, 'H':0.33818, 'S':-0.36468}
F2Rcharges = {'C':-0.84492, 'H':0.33094, 'S':-0.37924}
FHO_Cyscharges = {'C':-0.81732, 'H':0.34788, 'S':-0.22607}
FHO_Hischarges = {'CB':-0.70937, 'HB':0.37533, 'ND1':-0.56083, 'HD1':0.43762, 'CG':0.08468, 'CE1':0.15479,\
                  'HE1':0.24623, 'NE2':-0.50194, 'CD2':-0.08168, 'HD2':0.25417}
